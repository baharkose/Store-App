...
const ProductDetail = () => {
  ...
  // ? ARAMA SONUÇLARININ GERİ TUŞUNDA KAYBOLMAMASI - hem apiye istek atmanın önüne geçer hem verilerin kaybolmasını önler.Neden global alana ihtiyaç duyuyoruz bu sorunun cevabı da bu aslında
  ...
  const getDetailData = async () => {
    try {
      ...
      `https://dummyjson.com/products/${search.split("=")[1]}`
    );
    console.log(data);
    } catch (error) {
      console.log(error)
